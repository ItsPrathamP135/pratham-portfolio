    ...
    <div className={`container ${darkMode ? "dark" : "light"}`}>
      ...
      <div className="theory-section">
        ...
        <p className="description">
          Insertion Sort builds the sorted array one element at a time. It works
          similarly to arranging playing cards in your hand — pick one card,
          compare it with the already sorted cards, shift cards to the right,
        ...
        <div className="characteristics-grid">
          ...
          <div className="card">
            <h3>✅ Stability</h3>
            <p>
              <strong>Yes, Stable</strong>
            </p>
            <p>
              Shifts elements instead of swapping, preserving relative order
            </p>
          </div>
        ...
        <div className="steps-explanation">
          <div className="step">
            ...
            <div className="step-content">
              ...
              <p>
                Take the next element from the unsorted portion as the key to
                insert
              </p>
            </div>
          </div>
          ...
          <div className="step">
            ...
            <div className="step-content">
              ...
              <p>
                Compare the key with elements in the sorted portion from right
                to left
              </p>
            </div>
          </div>
          ...
          <div className="step">
            ...
            <div className="step-content">
              ...
              <p>
                Shift all greater (or smaller) elements one position to the
                right to make room
              </p>
            </div>
          </div>
          ...
          <div className="step">
            ...
            <div className="step-content">
              ...
              <p>
                Place the key at its correct sorted position. Sorted portion
                grows by one
              </p>
            </div>
          </div>
