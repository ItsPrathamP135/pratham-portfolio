    ...
    <div className={`container ${darkMode ? "dark" : "light"}`}>
      ...
      <div className="theory-section">
        ...
        <p className="description">
          ...
          order. After each full pass, the largest unsorted element "bubbles up"
        ...
        <div className="steps-explanation">
          <div className="step">
            ...
            <div className="step-content">
              ...
              <p>
                Start from the beginning and compare each pair of adjacent
          ...
          <div className="step">
            ...
            <div className="step-content">
              ...
              <p>
                If arr[j] arr[j+1] (for ascending), swap them using a temporary
                variable
              </p>
            </div>
          </div>
          ...
          <div className="step">
            ...
            <div className="step-content">
              ...
              <p>
                Continue passes until no swaps occur. Use isSwap flag for early
                termination
              </p>
            </div>
          </div>
